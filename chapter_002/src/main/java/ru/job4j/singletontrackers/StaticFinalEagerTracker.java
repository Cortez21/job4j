 ...
 * @since 0.1
 */
public class StaticFinalEagerTracker {
    private final Tracker tracker = new Tracker();
    private static final StaticFinalEagerTracker INSTANCE = new StaticFinalEagerTracker();

    private StaticFinalEagerTracker() {
    }

    public static StaticFinalEagerTracker getInstance() {
        return INSTANCE;
    }
    /**
